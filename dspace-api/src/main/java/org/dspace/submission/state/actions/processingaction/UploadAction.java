 ...
 * @version $Revision$
 */
public class UploadAction extends ProcessingAction
{
            ...
            AuthorizeException
    {
        ...
        if (request.getParameter("bitstream_id") != null)
        {
            if (buttonPressed.equals(CANCEL_EDIT_BUTTON))
            {
                ...
                return new ActionResult(ActionResult.TYPE.TYPE_OUTCOME,ActionResult.EDIT_COMPLETE);
            }
            else
            {
        ...
        else if (buttonPressed.startsWith("submit_edit_"))
        {
            ...
            // bitstream
            return new ActionResult(ActionResult.TYPE.TYPE_OUTCOME,ActionResult.EDIT_BITSTREAM);
        }
        ...
        if (buttonPressed.equalsIgnoreCase("submit_remove_selected"))
        {
            ...
            if (request.getParameter("remove") != null)
            {
                ...
                for (int i = 0; i < removeIDs.length; i++)
                {
                    ...
                    if (status != STATUS_COMPLETE)
                    {
                        return new ActionResult(ActionResult.TYPE.TYPE_OUTCOME,status);
                    }
                }
...
//            }
        ...
        if (fileRequired && !item.hasUploadedFiles())
        {
            //return new ActionResult(ActionResult.TYPE.TYPE_OUTCOME,ActionResult.NO_FILES_ERROR);
        }
