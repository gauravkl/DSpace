 ...
 * @version $Revision$
 */
public class DescribeAction extends ProcessingAction
{
    /** log4j logger */
    private static Logger log = Logger.getLogger(DescribeAction.class);
    ...
    /** Constructor */
    public DescribeAction() throws ServletException
    {
            ...
            AuthorizeException
    {
        ...
        if(getNumberOfPages(request,subInfo)>currentPage)
        {
