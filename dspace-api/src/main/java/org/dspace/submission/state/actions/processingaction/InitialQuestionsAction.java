 ...
 * @version $Revision$
 */
public class InitialQuestionsAction extends ProcessingAction
{
    /***************************************************************************
            ...
            AuthorizeException
    {
        ...
        if (isThesis)
        {
            ...
            return  new ActionResult(ActionResult.TYPE.TYPE_OUTCOME,ActionResult.THESIS_REJECTED);//return STATUS_THESIS_REJECTED; // since theses are disabled, throw
                                            // an error!
        }
        ...
        {
            return  new ActionResult(ActionResult.TYPE.TYPE_OUTCOME,ActionResult.CANCEL_PRUNE); // cancelled pruning!
        }
        ...
        // otherwise, check if pruning is necessary
        {
            ...
            if (willRemoveTitles || willRemoveDate || willRemoveFiles)
            {
                ...
                request.setAttribute("will.remove.files", Boolean.valueOf(willRemoveFiles));
                 ...
                 return  new ActionResult(ActionResult.TYPE.TYPE_OUTCOME,ActionResult.VERIFY_PRUNE);//return STATUS_VERIFY_PRUNE; // we will need to do pruning!
            }
        }
