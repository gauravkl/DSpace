 ...
 * of AbstractXMLUIAction class.
 * 
 * @author Scott Phillips
 * @author Tim Donohue (updated for Configurable Submission)
 */
public class ReviewActionXMLUI extends AbstractXMLUIAction
{

	/** Language Strings **/
    protected static final Message T_head = 
        message("xmlui.Submission.submit.ReviewActionXMLUI.head");
    protected static final Message T_yes = 
        message("xmlui.Submission.submit.ReviewActionXMLUI.yes");
    protected static final Message T_no = 
        message("xmlui.Submission.submit.ReviewActionXMLUI.no");
    protected static final Message T_submit_jump = 
        message("xmlui.Submission.submit.ReviewActionXMLUI.submit_jump");
    protected static final Message T_no_metadata = 
        message("xmlui.Submission.submit.ReviewActionXMLUI.no_metadata");
    protected static final Message T_unknown = 
        message("xmlui.Submission.submit.ReviewActionXMLUI.unknown");
    protected static final Message T_known = 
        message("xmlui.Submission.submit.ReviewActionXMLUI.known");
    protected static final Message T_supported = 
        message("xmlui.Submission.submit.ReviewActionXMLUI.supported");
	...
	/**
	 * Establish our required parameters, AbstractXMLUIAction will enforce these.
	 */
	public ReviewActionXMLUI()
	{
...
//            AbstractXMLUIAction stepUIClass = loadXMLUIClass(stepConfig.getXMLUIClassName());
//
//            try
//            {
...
//            catch(Exception e)
//            {
//                throw new UIException("Unable to initialize AbstractXMLUIAction identified by "
//                                        + stepConfig.getXMLUIClassName() + ":", e);
//            }
//
//            //If this stepUIClass is not a value AbstractXMLUIAction,
//            //we will be unable to display its review information!
//            if(stepUIClass instanceof AbstractXMLUIAction)
//            {
//                //add the Review section for this step,
//                //and return a reference to that newly created step section
//                List stepSection = ((AbstractXMLUIAction) stepUIClass).addReviewSection(review);
//
...
//                log.warn("The Step represented by " + stepConfig.getXMLUIClassName() + " is not a valid AbstractXMLUIAction, so it cannot be reviewed during the ReviewActionXMLUI!");
//            }
//        }
     ...
     * for a given step
     * 
     * @return AbstractXMLUIAction which references
     *          the XML-UI Class
     */
    private AbstractXMLUIAction loadXMLUIClass(String transformerClassName) 
        throws UIException
    {
        try
        {
            ...
            // this XML-UI class *must* be a valid AbstractXMLUIAction, 
            // or else we'll have problems here
            return (AbstractXMLUIAction) stepClass
                        .newInstance();
        }
        ...
        {
            //means we couldn't instantiate the class as an AbstractXMLUIAction
            throw new UIException("Unable to instantiate class " + transformerClassName + ". " +
                                          "Please make sure it extends org.dspace.app.xmlui.submission.AbstractXMLUIAction!", e);
        }
    }
