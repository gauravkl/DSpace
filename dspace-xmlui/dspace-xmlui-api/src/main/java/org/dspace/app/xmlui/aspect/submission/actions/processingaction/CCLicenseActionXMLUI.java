 ...
 */
public class CCLicenseActionXMLUI extends AbstractXMLUIAction
{
	/** Language Strings **/
    protected static final Message T_head = 
        message("xmlui.Submission.submit.CCLicenseActionXMLUI.head");
    protected static final Message T_info1 = 
        message("xmlui.Submission.submit.CCLicenseActionXMLUI.info1");
    protected static final Message T_submit_to_creative_commons = 
        message("xmlui.Submission.submit.CCLicenseActionXMLUI.submit_to_creative_commons");
    protected static final Message T_license = 
        message("xmlui.Submission.submit.CCLicenseActionXMLUI.license");
    protected static final Message T_submit_remove = 
        message("xmlui.Submission.submit.CCLicenseActionXMLUI.submit_remove");
    protected static final Message T_no_license = 
        message("xmlui.Submission.submit.CCLicenseActionXMLUI.no_license");
