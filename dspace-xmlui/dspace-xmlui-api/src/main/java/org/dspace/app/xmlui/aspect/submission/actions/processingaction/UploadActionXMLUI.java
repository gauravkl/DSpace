 ...
 */
public class UploadActionXMLUI extends AbstractXMLUIAction
{
	/** Language Strings for Uploading **/
    protected static final Message T_head = 
        message("xmlui.Submission.submit.UploadActionXMLUI.head");
    protected static final Message T_file = 
        message("xmlui.Submission.submit.UploadActionXMLUI.file");
    protected static final Message T_file_help = 
        message("xmlui.Submission.submit.UploadActionXMLUI.file_help");
    protected static final Message T_file_error = 
        message("xmlui.Submission.submit.UploadActionXMLUI.file_error");
    protected static final Message T_upload_error =
        message("xmlui.Submission.submit.UploadActionXMLUI.upload_error");

    protected static final Message T_virus_checker_error =
        message("xmlui.Submission.submit.UploadActionXMLUI.virus_checker_error");
    protected static final Message T_virus_error =
        message("xmlui.Submission.submit.UploadActionXMLUI.virus_error");

    protected static final Message T_description = 
        message("xmlui.Submission.submit.UploadActionXMLUI.description");
    protected static final Message T_description_help = 
        message("xmlui.Submission.submit.UploadActionXMLUI.description_help");
    protected static final Message T_submit_upload = 
        message("xmlui.Submission.submit.UploadActionXMLUI.submit_upload");
    protected static final Message T_head2 = 
        message("xmlui.Submission.submit.UploadActionXMLUI.head2");
    protected static final Message T_column0 = 
        message("xmlui.Submission.submit.UploadActionXMLUI.column0");
    protected static final Message T_column1 = 
        message("xmlui.Submission.submit.UploadActionXMLUI.column1");
    protected static final Message T_column2 = 
        message("xmlui.Submission.submit.UploadActionXMLUI.column2");
    protected static final Message T_column3 = 
        message("xmlui.Submission.submit.UploadActionXMLUI.column3");
    protected static final Message T_column4 = 
        message("xmlui.Submission.submit.UploadActionXMLUI.column4");
    protected static final Message T_column5 = 
        message("xmlui.Submission.submit.UploadActionXMLUI.column5");
    protected static final Message T_column6 = 
        message("xmlui.Submission.submit.UploadActionXMLUI.column6");
    protected static final Message T_unknown_name = 
        message("xmlui.Submission.submit.UploadActionXMLUI.unknown_name");
    protected static final Message T_unknown_format = 
        message("xmlui.Submission.submit.UploadActionXMLUI.unknown_format");
    protected static final Message T_supported = 
        message("xmlui.Submission.submit.UploadActionXMLUI.supported");
    protected static final Message T_known = 
        message("xmlui.Submission.submit.UploadActionXMLUI.known");
    protected static final Message T_unsupported = 
        message("xmlui.Submission.submit.UploadActionXMLUI.unsupported");
    protected static final Message T_submit_edit = 
        message("xmlui.Submission.submit.UploadActionXMLUI.submit_edit");
    protected static final Message T_checksum = 
        message("xmlui.Submission.submit.UploadActionXMLUI.checksum");
    protected static final Message T_submit_remove = 
        message("xmlui.Submission.submit.UploadActionXMLUI.submit_remove");
...
//        if(this.errorFlag==org.dspace.submit.step.UploadActionXMLUI.STATUS_EDIT_BITSTREAM)
//        {
