...
// */
public class CompleteActionXMLUI extends AbstractXMLUIAction
{
//
//	/** Language Strings **/
	protected static final Message T_head =
        message("xmlui.Submission.submit.CompleteActionXMLUI.head");
	protected static final Message T_info1 =
        message("xmlui.Submission.submit.CompleteActionXMLUI.info1");
    protected static final Message T_go_submission =
        message("xmlui.Submission.submit.CompleteActionXMLUI.go_submission");
	protected static final Message T_submit_again =
        message("xmlui.Submission.submit.CompleteActionXMLUI.submit_again");

//	/**
//	 * Establish our required parameters, abstractStep will enforce these.
//	 */
//	public CompleteActionXMLUI()
//	{
